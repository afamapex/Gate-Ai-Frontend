...
.hero{min-height:100svh;padding:150px 0 78px;background:url('/images/background/bg-hero.png') center center/cover no-repeat;display:flex;align-items:center;}.hero::after{content:'';position:absolute;inset:0;background:linear-gradient(90deg,rgba(255,255,255,.30) 0%,rgba(255,255,255,.06) 50%,rgba(255,255,255,.18) 100%);pointer-events:none}.section-overlay{position:relative;z-index:2}.section-overlay::before{content:'';position:absolute;inset:-16px -20px;border-radius:16px;background:rgba(255,255,255,.72);backdrop-filter:blur(4px);z-index:-1;pointer-events:none}.hero-globe-canvas{position:absolute;inset:0;width:100%;height:100%;z-index:1;pointer-events:none;opacity:.92;mix-blend-mode:normal}.hero-inner{display:grid;grid-template-columns:minmax(380px,480px) 1fr;gap:32px;align-items:center;min-height:calc(100svh - 220px);position:relative;z-index:4}.hero-left{position:relative;z-index:5;max-width:500px}.hero-left .eyebrow{margin-bottom:28px}.hero-left .h-display{margin-bottom:28px}.hero-left .accent{font-style:italic;font-weight:800}.hero-lede{font-size:clamp(15px,1.1vw,18px);line-height:1.55;color:#273254;max-width:710px;margin:0 0 36px}.hero-lede br+*{color:inherit}.hero-ctas{display:flex;gap:16px;align-items:center;flex-wrap:wrap}.hero-right{position:relative;z-index:6;display:flex;justify-content:center;padding-left:0}.hero-globe-counter{position:absolute;left:51%;bottom:8.4%;transform:translateX(-50%);z-index:5;display:flex;align-items:center;gap:16px;padding:14px 22px;border-radius:18px;background:rgba(255,255,255,.82);border:1px solid rgba(200,210,235,.7);box-shadow:0 18px 40px rgba(40,60,120,.12);backdrop-filter:blur(14px)}.hgc-item{display:flex;align-items:center;gap:7px;font-size:14px;font-weight:800;color:#253052}.hgc-dot{width:9px;height:9px;border-radius:50%;display:inline-block;box-shadow:0 0 14px currentColor}.hgc-red{background:var(--danger);color:var(--danger)}.hgc-green{background:var(--green);color:var(--green)}.hgc-item + .hgc-item{border-left:1px solid #dce3f2;padding-left:16px}
...
@media(max-width:720px){.hero{padding:96px 0 48px;min-height:auto;overflow:hidden}.hero-globe-canvas{opacity:.38;z-index:0;position:absolute;top:0;left:0;width:100%!important;height:100%!important;object-fit:cover}.hero-inner{display:block;position:relative;z-index:5}.hero-left{max-width:100%;padding:20px 20px 24px;background:rgba(255,255,255,.78);backdrop-filter:blur(8px);border-radius:18px;margin-bottom:20px}.hero-right{display:none}.h-display{font-size:clamp(36px,9.5vw,50px);line-height:1.0}.h-section{font-size:clamp(26px,7vw,38px)}.hero-lede{font-size:13.5px;line-height:1.55;margin-bottom:18px}.hero-ctas{flex-direction:row;flex-wrap:wrap;gap:10px}.hero-ctas .btn{font-size:13px;padding:11px 18px}.phone-section{display:block}.phone-shell{width:min(100%,320px);margin:0 auto}.phone-bezel{padding:7px;border-radius:44px}.phone-frame{border-radius:36px}.hero-globe-counter{position:relative;left:auto;bottom:auto;transform:none;margin:20px auto 0;width:max-content;font-size:13px;padding:10px 16px}.stats-panel{grid-template-columns:1fr}.stat-cell{border-right:0!important;border-bottom:1px solid #dbe3f4;min-height:auto;padding:28px 24px 24px}.stat-cell .stat-icon-circle{position:relative;top:auto;left:auto;margin-bottom:16px}.stat-cell .stat-viz{display:block;opacity:.12}.stat-cell .stat-num{font-size:clamp(44px,12vw,64px);margin-bottom:10px}.stat-cell:last-child{border-bottom:0}.problem,.stats,#capabilities,#pricing,#faq,.industries,.integrations,.cta{padding:64px 0!important}.problem-grid{grid-template-columns:1fr;gap:18px}.problem-card{min-height:auto;padding:28px 28px 24px}.caps-grid{grid-template-columns:1fr;gap:18px}.cap{min-height:auto;padding:28px 28px 24px}.pricing-grid{grid-template-columns:1fr;gap:18px}.industry-chip{width:100%;justify-content:center}.integrations-grid{gap:12px}.int-card{min-width:140px;height:62px;font-size:14px;padding:0 18px}.int-logo{width:28px;height:28px}.ind-stats{grid-template-columns:1fr}.nav-cta .btn-ghost{display:none}.faq-item summary{font-size:15px;padding:18px 20px}.faq-item p{padding:0 20px 18px;font-size:14px}.hero-globe-counter{font-size:13px;padding:11px 16px;gap:10px}}
