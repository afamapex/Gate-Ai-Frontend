...
export default function Landing() {
  ...
  return (
    <>
      ...
      </section> — mobile only, hidden on desktop */}
...
@media(max-width:720px){.hero{padding:108px 0 52px;min-height:auto}.hero-globe-canvas{opacity:.45;z-index:0}.hero-inner{display:flex;flex-direction:column;gap:0;min-height:auto;padding-bottom:0}.hero-left{max-width:100%;background:linear-gradient(180deg,rgba(255,255,255,.82) 0%,rgba(255,255,255,.65) 80%,transparent 100%);padding:24px 20px 20px;border-radius:20px;position:relative;z-index:5}.h-display{font-size:clamp(38px,10vw,52px)}.h-section{font-size:clamp(28px,8vw,40px)}.hero-lede{font-size:14px;line-height:1.55;margin-bottom:20px}.hero-ctas{flex-direction:row;flex-wrap:wrap;gap:10px}.hero-ctas .btn{font-size:13px;padding:12px 20px}.hero-right{display:none}.phone-section{display:block}.phone-shell{width:min(100%,320px);margin:0 auto}.phone-bezel{padding:8px;border-radius:48px}.phone-frame{border-radius:38px}.hero-globe-counter{position:relative;left:auto;bottom:auto;transform:none;margin:24px auto 0;width:max-content}.stats-panel{grid-template-columns:1fr}.stat-cell{border-right:0!important;border-bottom:1px solid #dbe3f4;min-height:auto;padding:28px 24px 24px}.stat-cell .stat-icon-circle{position:relative;top:auto;left:auto;margin-bottom:16px}.stat-cell .stat-viz{display:none}.stat-cell .stat-num{font-size:clamp(44px,12vw,64px);margin-bottom:10px}.stat-cell:last-child{border-bottom:0}.problem,.stats,#capabilities,#pricing,#faq,.industries,.integrations,.cta{padding:64px 0!important}.problem-grid{grid-template-columns:1fr;gap:18px}.problem-card{min-height:auto;padding:28px 28px 24px}.caps-grid{grid-template-columns:1fr;gap:18px}.cap{min-height:auto;padding:28px 28px 24px}.pricing-grid{grid-template-columns:1fr;gap:18px}.industry-chip{width:100%;justify-content:center}.integrations-grid{gap:12px}.int-card{min-width:140px;height:62px;font-size:14px;padding:0 18px}.int-logo{width:28px;height:28px}.ind-stats{grid-template-columns:1fr}.nav-cta .btn-ghost{display:none}.faq-item summary{font-size:15px;padding:18px 20px}.faq-item p{padding:0 20px 18px;font-size:14px}.hero-globe-counter{font-size:13px;padding:11px 16px;gap:10px}}
