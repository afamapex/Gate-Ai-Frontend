...
@media(max-width:720px){.hero{padding:100px 16px 44px;min-height:100svh;position:relative;overflow:hidden}.hero-globe-canvas{position:absolute!important;top:50%!important;left:50%!important;transform:translate(-50%,-50%)!important;width:120vw!important;height:120vw!important;opacity:.28;z-index:0}.hero-inner{display:flex!important;flex-direction:column!important;align-items:flex-start;gap:16px;width:100%;position:relative;z-index:5;min-height:auto}.hero-left{width:100%;max-width:100%;background:rgba(255,255,255,.84);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);border-radius:18px;padding:20px 18px 18px}.hero-right{display:none!important}.h-display{font-size:clamp(34px,9vw,46px);line-height:1.02;letter-spacing:-.04em}.hero-lede{font-size:13px;line-height:1.5;margin:10px 0 16px}.hero-ctas{flex-direction:row;flex-wrap:wrap;gap:8px}.hero-ctas .btn{font-size:13px;padding:10px 16px}.hero-globe-counter{position:relative!important;left:auto!important;bottom:auto!important;transform:none!important;margin:14px auto 0;width:max-content;font-size:12px;padding:9px 14px}.phone-section{display:block}.phone-shell{width:min(100%,300px);margin:0 auto}.phone-bezel{padding:7px;border-radius:44px}.phone-frame{border-radius:36px}.stats-panel{grid-template-columns:1fr}.stat-cell{border-right:0!important;border-bottom:1px solid #dbe3f4;min-height:auto;padding:24px 20px}.stat-cell .stat-icon-circle{position:relative;top:auto;left:auto;margin-bottom:12px}.stat-cell .stat-viz{display:block;opacity:.12}.stat-cell .stat-num{font-size:clamp(42px,11vw,60px);margin-bottom:8px}.stat-cell:last-child{border-bottom:0}.problem,.stats,#capabilities,#pricing,#faq,.industries,.integrations,.cta{padding:60px 0!important}.problem-grid{grid-template-columns:1fr;gap:16px}.problem-card{min-height:auto;padding:24px}.caps-grid{grid-template-columns:1fr;gap:16px}.cap{min-height:auto;padding:24px}.pricing-grid{grid-template-columns:1fr;gap:16px}.industry-chip{width:100%;justify-content:center}.integrations-grid{gap:10px}.int-card{min-width:130px;height:58px;font-size:13px;padding:0 14px}.ind-stats{grid-template-columns:1fr}.faq-item summary{font-size:14px;padding:16px 18px}.faq-item p{padding:0 18px 16px;font-size:13px}.h-section{font-size:clamp(28px,8vw,40px)}.hero-eyebrow{font-size:10px}.nav-cta .btn-ghost{display:flex!important;font-size:12px!important;padding:7px 12px!important;white-space:nowrap}}
