  ...
  useEffect(() => {
    ...
    function initGlobe() {
      ...
      const ffU = {
        ...
        baseColor:{value:new THREE.Color(0x0077ff)},
...
@media(max-width:1100px){.hero-inner{grid-template-columns:1fr;gap:36px}.hero-right{justify-content:center}.hero-globe-counter{left:50%;bottom:4%}.problem-grid,.pricing-grid{grid-template-columns:1fr}.caps-grid{grid-template-columns:1fr}.stats-panel{grid-template-columns:repeat(2,1fr)}.stat-cell:nth-child(2){border-right:0}.stat-cell:nth-child(-n+2){border-bottom:1px solid #dbe3f4}.cta-float-left,.cta-float-right{display:none!important}}
@media(max-width:720px){.hero{padding:116px 0 64px}.hero-globe-canvas{opacity:.62}.hero-inner{display:block}.hero-left{max-width:100%}.h-display{font-size:52px}.hero-lede{font-size:17px}.hero-right{display:none}.phone-section{display:block}.hero-globe-counter{position:relative;left:auto;bottom:auto;transform:none;margin:34px auto 0;width:max-content}.stats-panel{grid-template-columns:1fr}.stat-cell{border-right:0!important;border-bottom:1px solid #dbe3f4}.stat-cell:last-child{border-bottom:0}.problem,.stats,#capabilities,#pricing,#faq,.industries,.integrations,.cta{padding:72px 0!important}.industry-chip{width:100%;justify-content:center}.ind-stats{grid-template-columns:1fr}.nav-cta .btn-ghost{display:none}}
